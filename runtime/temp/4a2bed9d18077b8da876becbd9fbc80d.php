<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:104:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/admin\view\index\addcourse.html";i:1528812358;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name"
                       placeholder="请输入课程名,例如：PHP程序设计" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
