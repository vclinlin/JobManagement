<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:104:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/index\view\teachers\course.html";i:1531802424;s:85:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\application\index\view\layout.html";i:1531482937;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="d-flex flex-wrap">
        <div class="col-lg-2 card-top col-sm-3 col-6 p-sm-2">
            <div class="card">
                ...
                <div class="card-footer text-center">新增课程</div>    <!-- 描述 -->
            </div>
        </div>
        ...
        <div class="col-lg-2 card-top col-sm-3 col-6 p-sm-2" title="<?php echo $data['class_name']; ?>-<?php echo $data['grade']; ?>级<?php echo $data['sequence']; ?>班">
