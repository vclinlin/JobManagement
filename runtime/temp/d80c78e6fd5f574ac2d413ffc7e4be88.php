<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:111:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/index\view\students\CourseDetails.html";i:1532269610;s:85:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\application\index\view\layout.html";i:1531482937;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="line-one container">
    ...
    <div class="row p-2 m-2 bg-light border">
        ...
        <div class="col-sm-3 d-flex justify-content-center flex-column">
            ...
            <input type="button" class="btn btn-block btn-success" data-id="<?php echo $data['Id']; ?>" value="答题"/>
            <?php else: ?>
