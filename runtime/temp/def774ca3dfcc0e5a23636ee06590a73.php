<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:104:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/admin\view\user\notteacher.html";i:1529239475;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <xblock>
        ...
        <span class="x-right" style="line-height:40px">未注册教师：<?php echo $count; ?> 名</span>
      </xblock>
      ...
      <div class="page">
        <div>
          <a class="prev" href="./NotTeachersView?page=<?php echo $page-1; ?>">&lt;&lt;</a>
          <a class="num" href="./NotTeachersView?page=<?php echo $page-1; ?>"><?php echo $page-1; ?></a>
          <span class="current"><?php echo $page; ?></span>
          <a class="num" href="./NotTeachersView?page=<?php echo $page+1; ?>">
            <?php
          ...
          <a class="num" href="./NotTeachersView?page=<?php echo $num; ?>"><?php echo $num; ?></a>
          <a class="next" href="./NotTeachersView?page=<?php echo $page+1; ?>">&gt;&gt;</a>
        </div>
      </div>
