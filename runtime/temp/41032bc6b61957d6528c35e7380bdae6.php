<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:104:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/admin\view\user\addteacher.html";i:1529034984;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="number"
                       placeholder="请输入教师号,例如013010**" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select id="department_id" name="department_id" lay-verify="required">
                    ...
                    <?php if(is_array($dep_Data) || $dep_Data instanceof \think\Collection || $dep_Data instanceof \think\Paginator): $i = 0; $__LIST__ = $dep_Data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
