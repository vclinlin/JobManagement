<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"D:\Vc_PHP\Apache24\htdocs\2018\WorkManagement\shop\public/../application/admin\view\user\student.html";i:1529031892;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加学生','/admin/user/addstudentview')">
        ...
        <span class="x-right" style="line-height:40px">已注册学生：<?php echo $count; ?> 名</span>
      </xblock>
      <table class="layui-table">
        ...
        <?php if(is_array($StudentData) || $StudentData instanceof \think\Collection || $StudentData instanceof \think\Paginator): $i = 0; $__LIST__ = $StudentData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
          <tr>
            ...
            <td><?php echo $data['class_name']; ?> - <?php echo $data['grade']; ?>级<?php echo $data['sequence']; ?>班</td>
            <td class="td-status">
              <?php if(($data['state']==1)): ?>
            ...
            <td class="td-manage" style="text-align: center">
              ...
              <button title="冻结" class="layui-btn layui-btn-sm"
                      onclick="member_stop(this,<?php echo $data['Id']; ?>)">
              ...
              <button class="layui-btn layui-btn-sm" title="编辑"
                      onclick="x_admin_show('编辑','/admin/user/upstudentview/?id=<?php echo $data['Id']; ?>')"
              >
                <i class="layui-icon">&#xe642;</i>
              </button>
              <button class="layui-btn layui-btn-sm" title="重置密码"
                      onclick="reset_pass(<?php echo $data['number']; ?>,<?php echo $data['Id']; ?>)"
              >
                <i class="layui-icon">&#xe669;</i>
              </button>
      ...
      <div class="page">
        <div>
          <a class="prev" href="./StudentView?page=<?php echo $page-1; ?>">&lt;&lt;</a>
          <a class="num" href="./StudentView?page=<?php echo $page-1; ?>"><?php echo $page-1; ?></a>
          <span class="current"><?php echo $page; ?></span>
          <a class="num" href="./StudentView?page=<?php echo $page+1; ?>">
            <?php
          ...
          <a class="num" href="./StudentView?page=<?php echo $num; ?>"><?php echo $num; ?></a>
          <a class="next" href="./StudentView?page=<?php echo $page+1; ?>">&gt;&gt;</a>
        </div>
      </div>
